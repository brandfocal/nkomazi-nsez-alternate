...
const Hero = () => {
  ...
  return <section ref={heroRef} className="relative flex flex-col justify-end" style={{
    overflow: 'hidden',
    height: '100vh',
    minHeight: '580px'
  }}>
    ...
    {/* Main hero content */}
    <motion.div className="absolute left-0 right-0 px-4 sm:px-8 lg:px-[clamp(32px,5.5vw,80px)]" style={{
